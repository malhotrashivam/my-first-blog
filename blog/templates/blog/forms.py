...
# PostForm, as you probably suspect, is the name of our form. We need to tell Django, that this form is a ModelForm (so Django 
# will do some magic for us) - forms.ModelForm is responsible for that.
...
# author should be the person who is currently logged in (you!) and created_date should be automatically set when we create a 
# post (i.e in the code), right?